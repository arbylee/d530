class TextureSampler39 extends AbstractTextureSampler {
  ...
  private static GameString aClass94_3286 = SpawnedGameObject.createString("Loading )2 please wait)3");
  ...
  static final boolean method278(int var0, byte[] var1) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var5, "nh.AA(" + var0 + ',' + (var1 != null ? "{...}" : "null") + ')');
    }
  }
  ...
  static final void updateVariable(int id, int var1) {
    try {
      ...
      VariableUpdate var3 =
        (VariableUpdate) ClientScript.variableUpdates.get((long) id);
      if (null != var3) {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "nh.W(" + var1 + ',' + id + ')');
    }
  }
