final class AudioStreamEncoder4 extends AudioStreamEncoder {
        ...
        if (var12 != null) {
          ...
          if (this.anIntArray3519[var2] == 0) {
            var7.aClass3_Sub24_Sub1_2507 =
              AudioStreamEncoder1.method432(var12, this.method498((byte) 85, var7),
                this.method508((byte) 36, var7), this.method496(0, var7));
          } else {
            var7.aClass3_Sub24_Sub1_2507 =
              AudioStreamEncoder1.method432(var12, this.method498((byte) 85, var7), 0,
    ...
    try {
      ...
      if (var3.anInt2506 >= 0 && (var3.aClass3_Sub24_Sub1_2507 == null
        ...
        if (var8) {
          ...
          var3.aClass3_Sub24_Sub1_2507.method450(var3.anInt2512, this.method508((byte) 36, var3),
  ...
  private final int method498(byte var1, AudioSomethingSomething var2) {
    try {
      ...
      var5 = (int) (0.5D + (double) (256 * var2.aClass3_Sub12_Sub1_2509.anInt3034) * Math.pow(2.0D,
        (double) var3 * 3.255208333333333E-4D) / (double) DummyClass60.sampleRate);
      if (var1 != 85) {
        this.method414();
      }
              ...
              if (-1 > ~var3.anIntArray254[var15]) {
                ...
                if (1 == Something3d.anInt3012 && var9.method99(31595)) {
                  ...
                  if (0 != (16 & Something3dRoot.anInt2051) && (var18 == null
                    ...
                    ScriptState.method1177(BufferObject.anInt1887, (long) var10.anInt787,
                  ...
                  if (var9.method96(-2063688673)) {
                    ...
                    ScriptState.method1177(DummyClass54.anInt1403, (long) var10.anInt787,
          ...
          for (var15 = 9; var15 >= 5; --var15) {
            ...
            if (null != var16) {
              ScriptState.method1177(TextureSampler6.method173((byte) 126, var15, var3),
                (long) (var15 + 1), (byte) -85, var3.aClass94_277, var3.anInt191, (short) 1003,
                var16, var3.anInt279);
          ...
          for (var5 = 4; -1 >= ~var5; --var5) {
            ...
            if (var17 != null) {
              ...
              ScriptState.method1177(TextureSampler6.method173((byte) 53, var5, var3),
                (long) (var5 - -1), (byte) -48, var3.aClass94_277, var3.anInt191, (short) 9, var17,
                var3.anInt279);
            }
          }
