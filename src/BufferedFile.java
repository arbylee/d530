...
final class BufferedFile {
  ...
  static GameString COMMAND_FPS_OFF = SpawnedGameObject.createString("::fpsoff");
  static GameString CHALLENGE_REQ = SpawnedGameObject.createString(":chalreq:");
  static int[] anIntArray574 = new int[14];
  static GameString aClass94_577 = SpawnedGameObject.createString("http:)4)4");
  ...
  BufferedFile(FileOnDisk var1, int var2, int var3) throws IOException {
    try {
    ...
    try {
      ...
      if (-1L != this.aLong571) {
        ...
        if (~this.aLong576 >= ~this.aLong571
          && ~(this.aLong576 + (long) this.anInt575) < ~this.aLong571) {
          var3 = this.aLong571;
        ...
        long var5 = -1L;
        if (this.aLong576 < this.aLong571 - -((long) this.anInt566)
          && (long) this.anInt575 + this.aLong576 >= (long) this.anInt566 + this.aLong571) {
          var5 = this.aLong571 - -((long) this.anInt566);
        } else if (~(this.aLong576 - -((long) this.anInt575)) < ~this.aLong571
          && (long) this.anInt566 + this.aLong571 >= (long) this.anInt575 + this.aLong576) {
          var5 = (long) this.anInt575 + this.aLong576;
        }

        if (-1L < var3 && ~var5 < ~var3) {
          int var7 = (int) (-var3 + var5);
          ArrayUtils.copy(this.aByteArray572, (int) (var3 - this.aLong571), this.aByteArray564,
    ...
    try {
      try {
        ...
        if (this.aLong576 <= this.aLong569
          && this.aLong576 + (long) this.anInt575 > this.aLong569) {
        ...
        if (-1L != this.aLong571) {
          ...
          long var16 = -1L;
          long var11 = -1L;
          if ((long) this.anInt566 + this.aLong571 > var5
            && (long) var8 + var5 >= (long) this.anInt566 + this.aLong571) {
            var11 = (long) this.anInt566 + this.aLong571;
          } else if (~this.aLong571 > ~((long) var8 + var5)
            && ~((long) this.anInt566 + this.aLong571) <= ~((long) var8 + var5)) {
  ...
  final void close(boolean var1) throws IOException {
    try {
  ...
  final void write(byte[] var1, int var2, int var3, int var4) throws IOException {
    try {
      try {
        ...
        if (0L != ~this.aLong571 && (this.aLong571 > this.aLong569 || ~this.aLong569 < ~(
          (long) this.anInt566 + this.aLong571))) {
        ...
        if (~this.aByteArray572.length > ~var4) {
          ...
          long var12 = -1L;
          if (this.aLong576 <= this.aLong569
            && ~((long) this.anInt575 + this.aLong576) < ~this.aLong569) {
            var12 = this.aLong569;
          } else if (~this.aLong569 >= ~this.aLong576
            && ~((long) var4 + this.aLong569) < ~this.aLong576) {
            var12 = this.aLong576;
          }
          ...
          if (this.aLong569 + (long) var4 > this.aLong576 && ~(this.aLong569 - -((long) var4)) >= ~(
            this.aLong576 - -((long) this.anInt575))) {
            var7 = (long) var4 + this.aLong569;
          } else if (~(this.aLong576 + (long) this.anInt575) < ~this.aLong569
            && this.aLong569 + (long) var4 >= (long) this.anInt575 + this.aLong576) {
            var7 = (long) this.anInt575 + this.aLong576;
          }

          if (~var12 < 0L && var7 > var12) {
            int var9 = (int) (-var12 + var7);
            ArrayUtils.copy(var1, (int) (-this.aLong569 + var12 + (long) var2), this.aByteArray564,
  ...
  final void seek(int var1, long var2) throws IOException {
    try {
      if (var2 >= 0L) {
        this.aLong569 = var2;
        if (var1 > -6) {
