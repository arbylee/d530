  ...
  static final void method224(byte var0, int var1, int var2, int var3, int var4, int var5) {
    try {
      ...
      if (GlRenderer.useOpenGlRenderer) {
        ...
        GlUtils.drawVerticalLine(14 + var3, 17 + (var4 - -var7), -1 + var6, SceneGraphTile.anInt2243);
        GlUtils.drawHorizontalLine(var3, var6 + 15 + var4 + var7, 16, SceneGraphTile.anInt2243);
        GlUtils.drawHorizontalLine(var3 + 1, var4 + 14 - -var7 + var6, 15, SceneGraphTile.anInt2243);
      } else {
        ...
        DummyClass47
          .method1317(1 + var3, var6 + var4 - (-14 + -var7), 15, SceneGraphTile.anInt2243);
      }
  ...
  static final void method225(int var0, Widget var1) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var5, "fn.Q(" + var0 + ',' + (var1 != null ? "{...}" : "null") + ')');
    }
  }
