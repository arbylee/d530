final class DummyClass56 {

  static int spawnSceneY;
  static Widget aClass11_1453;
  static GameString[] aClass94Array1454;
  static GameString aClass94_1455 = SpawnedGameObject.createString(" loggt sich aus)3");


  static final void method1645(FileUnpacker var0, FileUnpacker var1, byte var2) {
    try {
  ...
  static final void method1647(byte var0, int var1, int var2, Mobile var3, int var4, int var5,
                               int var6) {
    try {
      if (var0 != 122) {
        method1648(null, 7);
  ...
  static final void method1648(FileUnpacker var0, int var1) {
    try {
