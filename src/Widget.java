final class Widget {
  ...
  static GameString EVENT_OP_BASE = SpawnedGameObject.createString("event_opbase");
  static boolean aBoolean236 = true;
  static float aFloat246;
  static GameString aClass94_251 = null;
  static long aLong261 = 0L;
  static int anInt278 = -1;
  static GameString aClass94_297 = SpawnedGameObject.createString("Nehmen");
  ...
  GameString[] aClass94Array171;
  GameString aClass94_172;
  GameString[] aClass94Array173;
  ...
  byte aByte241;
  int anInt242;
  GameString aClass94_243;
  int anInt244;
  GameString aClass94_245;
  int anInt247;
  ...
  WidgetAccess aClass3_Sub1_257;
  int anInt258;
  int anInt259;
  int anInt260;
  Widget[] aClass11Array262;
  byte[] aByteArray263;
  int anInt264;
  int anInt265;
  int anInt266;
      ...
      if (this.anIntArray207 != null) {
        ...
        if (null == var2) {
          ...
          while (~var3 > ~var2.height) {
            ...
            while (true) {
              if (~var6 > ~var2.width) {
                if (-1 == ~var2.aByteArray2674[var2.width * var3 + var6]) {
                  ++var6;
                  continue;
                }
              ...
              for (var6 = var4; var2.width > var6; ++var6) {
                if (0 == var2.aByteArray2674[var3 * var2.width + var6]) {
                  var5 = var6;
                  break;
                }
              }
  ...
  final void method857(byte var1, GameString var2, int var3) {
    try {
  ...
  final void method858(int var1, Buffer var2) {
    try {
      if (var1 >= -94) {
        this.anInt214 = -74;
      }
      ...
      if (-1 == ~this.anInt187) {
        ...
        this.aBoolean155 = 1 == var2.readUnsignedByte();
      }
      ...
      if (7 == this.anInt187) {
        ...
        this.aBoolean215 = ~var2.readUnsignedByte() == -2;
        this.anInt218 = var2.readInt();
  ...
  final AbstractDirectColorSprite method859(boolean var1, int var2) {
    try {
      ...
      if (!var1) {
        ...
        if (~var3 != 0) {
          AbstractDirectColorSprite var4 =
            (AbstractDirectColorSprite) MonoChromaticImageCache.aClass93_1569.get((long) var3);
          if (var4 == null) {
            var4 = Structure.method602(0, var3, (byte) -18, SomethingSceneJ.aClass153_323);
            if (null != var4) {
              MonoChromaticImageCache.aClass93_1569.get((byte) -126, var4, (long) var3);
            } else {
      ...
      throw AbstractGameWorld.cascadeException(var5, "be.I(" + var1 + ',' + var2 + ')');
    }
  }

  private final Object[] method862(int var1, Buffer var2) {
    try {
      if (var1 != -65536) {
        return null;
      } else {
  ...
  private final int[] method863(Buffer var1, boolean var2) {
    try {
  ...
  final AbstractModel method865(int var1, AnimationSequence var2, int var3, int var4, int var5,
                                boolean var6, PlayerAppearance var7) {
    try {
      GameStub.aBoolean6 = false;
      int var8;
      int var9;
        ...
        if (-2 == ~var8 && var9 == -1) {
          ...
          if (1 == var8) {
            ...
            if (var10 == null) {
              ...
              SomethingVolume15.aClass93_2428.get((byte) -115, var10, (long) (var9 + (var8 << 16)));
            }
  ...
  final AbstractDirectColorSprite method866(byte var1, boolean var2) {
    try {
      GameStub.aBoolean6 = false;
      int var3;
      if (var2) {
      ...
      if (0 == ~var3) {
        ...
        long var4 =
          ((this.aBoolean178 ? 1L : 0L) << 38) + ((!this.aBoolean157 ? 0L : 1L) << 35) + (long) var3
        ...
        if (var6 != null) {
          ...
          if (null == var7) {
            ...
            return (AbstractDirectColorSprite) var9;
          }
        }
      }
  ...
  final void method867(int var1, Buffer var2) {
    try {
      ...
      this.aBoolean155 = -2 == ~var2.readUnsignedByte();
      if (~this.anInt187 == -1) {
      ...
      if (~this.anInt187 == -6) {
        ...
        this.aBoolean178 = ~var2.readUnsignedByte() == -2;
        this.aBoolean199 = 1 == var2.readUnsignedByte();
      }
      ...
      if (~this.anInt187 == -7) {
        ...
        this.aBoolean309 = 1 == var2.readUnsignedByte();
        if (this.aByte304 != 0) {
      ...
      var8 = var1;
      this.aClass94_245 = var2.readString();
      if (0 != ClientScript.method630((byte) -34, var3)) {
  ...
  final AbstractFont method868(AbstractIndexedColorSprite[] var1, int var2) {
    try {
      GameStub.aBoolean6 = false;
      if (0 == ~this.anInt270) {
        return null;
      } else {
        AbstractFont var3 = (AbstractFont) Cache.aClass93_743.get((long) this.anInt270);
        if (null != var3) {
          return var3;
        } else {
          ...
          if (null == var3) {
            ...
            Cache.aClass93_743.get((byte) -77, var3, (long) this.anInt270);
          }
