final class TextureSampler29 extends AbstractTextureSampler {
  ...
  static final void setupDefaultSun(int brightness) {
    try {
      GlEnvironment
        .setSunColor(GlEnvironment.defaultSunColor, (0.7F + (float) brightness * 0.1F) * 1.1523438F,
          0.69921875F, 0.69921875F);
  ...
  static final int getByteLength(GameString var1) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var3, "si.O(" + (var1 != null ? "{...}" : "null") + ')');
    }
  }
  ...
  static final void method327(int var0, int var1, byte var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "si.B(" + var0 + ',' + var1 + ',' + var2 + ')');
    }
  }
  ...
  private final void method323(int var1, int[][] var2) {
    try {
      ...
      DummyClass43.method1196(0, 0, (byte) 111, TriChromaticImageBuffer.anInt2487, RenderAnimation.anInt396);
      ...
      throw AbstractGameWorld
        .cascadeException(var9, "si.F(" + var1 + ',' + (var2 != null ? "{...}" : "null") + ')');
    }
  }
