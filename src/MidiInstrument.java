final class MidiInstrument extends Node {
  ...
  private static SomethingMidik[] aClass152Array2392;
  private static boolean[] aBooleanArray2393;
  private static int anInt2396;
  private static SomethingMidiOther[] aClass150Array2398;
  ...
  private static SomethingMidiI[] aClass59Array2407;
  ...
  final SomethingMusic0 method359(int[] var1) {
    if (var1 != null && var1[0] <= 0) {
      ...
      return new SomethingMusic0(this.anInt2408, var7, this.anInt2397, this.anInt2401,
        this.aBoolean2395);
    }
  }
  ...
  private final float[] method366(int var1) {
    ...
    method364();
    int var2 = method368(MonoChromaticImageBuffer.method513(anIntArray2420.length - 1, 4));
    ...
    SomethingMidiOther var14 = aClass150Array2398[anIntArray2420[var2]];
    ...
    for (var17 = 0; var17 < var14.anInt1931; ++var17) {
      SomethingMidik var18 = aClass152Array2392[var14.anIntArray1930[var17]];
