...
final class TextureSampler10 extends AbstractTextureSampler {

  static int anInt3439;
  static SoftwareFont aClass3_Sub28_Sub17_Sub1_3440;
  static BigInteger MODULUS = new BigInteger(
    "81039339797344825060606567969329007648997444195227810418834123766696332810507273543830611483562"
      + "95236738745674596363872065761750284786060607297409261403499");
  ...
  private final void method345(int var1, boolean var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var4, "um.B(" + var1 + ',' + var2 + ')');
    }
  }
      ...
      if (~var5 < -1) {
        for (int var6 = 0; var6 < 257; ++var6) {
          ...
          this.anIntArray3443[var6] =
            TextureSampler3.method308(var4, TextureSampler3.method308(var3 << 8, var2 << 16));
        }
      }

    } catch (RuntimeException var13) {
      throw AbstractGameWorld.cascadeException(var13, "um.E(" + var1 + ')');
    }
  }
