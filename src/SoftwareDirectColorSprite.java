class SoftwareDirectColorSprite extends AbstractDirectColorSprite {

  int[] pixels;


  SoftwareDirectColorSprite(int var1, int var2, int var3, int var4, int var5, int var6,
                            int[] var7) {
    this.anInt3697 = var1;
    this.anInt3706 = var2;
    this.anInt3701 = var3;
  ...
  SoftwareDirectColorSprite(int var1, int var2) {
    ...
    if (this.anInt3707 != this.anInt3697 || this.anInt3696 != this.anInt3706) {
      ...
      for (int var9 = 0; var9 < this.anInt3696; ++var9) {
        for (int var10 = 0; var10 < this.anInt3707; ++var10) {
          var8[(var9 + var4) * var6 + var10 + var2] = this.pixels[var9 * this.anInt3707 + var10];
        }
      }
  ...
  void method635(int var1, int var2) {
    ...
    if (var6 > 0 && var5 > 0) {
      method659(DummyClass47.anIntArray1100, this.pixels, var4, var3, var6, var5, var7, var8);
    }
  }
  ...
  void method636(int var1, int var2, int var3, int var4, int var5, int var6) {
    if (var6 != 0) {
      ...
      var21 >>= 4;
      var22 = var22 + 15 >> 4;
      if (var19 < DummyClass47.anInt1093) {
        var19 = DummyClass47.anInt1093;
      }

      if (var20 > DummyClass47.anInt1096) {
        var20 = DummyClass47.anInt1096;
      }

      if (var21 < DummyClass47.anInt1095) {
        var21 = DummyClass47.anInt1095;
      }

      if (var22 > DummyClass47.anInt1099) {
        var22 = DummyClass47.anInt1099;
      }
      ...
      if (var20 < 0) {
        var22 = var21 - var22;
        if (var22 < 0) {
          int var23 = var21 * DummyClass47.anInt1092 + var19;
          ...
          if (var27 == 0) {
            if (var26 == 0) {
              for (var33 = var22; var33 < 0; var23 += DummyClass47.anInt1092) {
                var34 = var23;
                var35 = var30;
                var36 = var31;
                var37 = var20;
                if (var30 >= 0 && var31 >= 0 && var30 - (this.anInt3707 << 12) < 0
                  && var31 - (this.anInt3696 << 12) < 0) {
                  for (; var37 < 0; ++var37) {
                    var38 = this.pixels[(var36 >> 12) * this.anInt3707 + (var35 >> 12)];
                    if (var38 != 0) {
                      DummyClass47.anIntArray1100[var34++] = var38;
                    } else {
                      ++var34;
                    }
                  }
  ...
  void method637(int var1, int var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) {
      method662(DummyClass47.anIntArray1100, this.pixels, 0, var5, var4, var7, var6, var8, var9,
        var3);
    }
  }
  ...
  void draw(int var1, int var2, int var3, int var4) {
    if (var3 > 0 && var4 > 0) {
      ...
      method670(DummyClass47.anIntArray1100, this.pixels, 0, var7, var8, var13, var14, var3, var4,
        var11, var12, var5);
    }
  }
  ...
  void method641(int var1, int var2) {
    ...
    if (var6 > 0 && var5 > 0) {
      method656(DummyClass47.anIntArray1100, this.pixels, 0, var4, var3, var6, var5, var7, var8);
    }
  }
  ...
  void method642(int var1, int var2, int var3, int var4, int var5) {
    if (var3 > 0 && var4 > 0) {
      ...
      method661(DummyClass47.anIntArray1100, this.pixels, 0, var8, var9, var14, var15, var3, var4,
  ...
  void method643(int var1, int var2) {
    ...
    if (var6 > 0 && var5 > 0) {
      method654(DummyClass47.anIntArray1100, this.pixels, 0, var4, var3, var6, var5, var7, var8);
    }
  }
      ...
      for (int var5 = 0; var5 < this.anInt3707; ++var5) {
        ...
        if (var6 == 0) {
          if (var5 > 0 && this.pixels[var3 - 1] != 0) {
            ...
            var6 = var1;
          } else if (var4 < this.anInt3696 - 1 && this.pixels[var3 + this.anInt3707] != 0) {
            var6 = var1;
          }
        }
  ...
  void method660(int var1, int var2, int var3, int var4, int var5, int var6, double var7,
                 int var9) {
    try {
      int var10 = -var3 / 2;
      int var11 = -var4 / 2;
      ...
      for (var2 = 0; var2 < var4; ++var2) {
        ...
        for (var1 = -var3; var1 < 0; ++var1) {
          ...
          if (var20 != 0) {
            DummyClass47.anIntArray1100[var17++] = var20;
          } else {
            ++var17;
          }
  ...
  void method664(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
                 int[] var9, int[] var10) {
    try {
      int var11 = -var3 / 2;
      int var12 = -var4 / 2;
      ...
      int var17 = var1 + var2 * DummyClass47.anInt1092;
      ...
      for (var2 = 0; var2 < var4; ++var2) {
        ...
        for (var1 = -var10[var2]; var1 < 0; ++var1) {
          DummyClass47.anIntArray1100[var19++] =
    ...
    if (this.anInt3707 != this.anInt3697 || this.anInt3696 != this.anInt3706) {
      ...
      for (int var2 = 0; var2 < this.anInt3696; ++var2) {
        for (int var3 = 0; var3 < this.anInt3707; ++var3) {
          var1[(var2 + this.anInt3698) * this.anInt3697 + var3 + this.anInt3701] =
  ...
  final void method666(int var1, int var2, int[] var3, int[] var4) {
    if (DummyClass47.anInt1099 - DummyClass47.anInt1095 != var3.length) {
      ...
      int var8 = DummyClass47.anInt1092 - var7;
      int var9 = 0;
      int var10 = var1 + var2 * DummyClass47.anInt1092;
      int var11;
      if (var2 < DummyClass47.anInt1095) {
        var11 = DummyClass47.anInt1095 - var2;
        var6 -= var11;
        var2 = DummyClass47.anInt1095;
        var5 += var11 * var7;
        var10 += var11 * DummyClass47.anInt1092;
      }
      ...
      if (var1 < DummyClass47.anInt1093) {
        var11 = DummyClass47.anInt1093 - var1;
        var7 -= var11;
        var1 = DummyClass47.anInt1093;
        var5 += var11;
        var10 += var11;
      ...
      if (var1 + var7 > DummyClass47.anInt1096) {
        var11 = var1 + var7 - DummyClass47.anInt1096;
        var7 -= var11;
        var9 += var11;
        var8 += var11;
      }
      ...
      if (var7 > 0 && var6 > 0) {
        var11 = var1 - DummyClass47.anInt1093;
        int var12 = var2 - DummyClass47.anInt1095;
        ...
        for (int var13 = var12; var13 < var12 + var6; ++var13) {
          ...
          for (int var18 = -var15; var18 < 0; ++var18) {
            ...
            if (var19 != 0) {
              DummyClass47.anIntArray1100[var10++] = var19;
            } else {
              ++var10;
            }
          }
    ...
    try {
      ...
      for (var2 = 0; var2 < var4; ++var2) {
        ...
        for (var1 = -var10[var2]; var1 < 0; ++var1) {
          ...
          if (var22 != 0) {
            DummyClass47.anIntArray1100[var19++] = var22;
          } else {
            ++var19;
          }
  ...
  final void method668(int var1) {
    for (int var2 = this.anInt3696 - 1; var2 > 0; --var2) {
      ...
      for (int var4 = this.anInt3707 - 1; var4 > 0; --var4) {
        if (this.pixels[var4 + var3] == 0 && this.pixels[var4 + var3 - 1 - this.anInt3707] != 0) {
  ...
  private static final void method654(int[] var0, int[] var1, int var2, int var3, int var4,
  ...
  private static final void method656(int[] var0, int[] var1, int var2, int var3, int var4,
                                      int var5, int var6, int var7, int var8) {
    int var9 = -(var5 >> 2);
    var5 = -(var5 & 3);
  ...
  private static final void method659(int[] var0, int[] var1, int var2, int var3, int var4,
  ...
  private static final void method661(int[] var0, int[] var1, int var2, int var3, int var4,
  ...
  private static final void method662(int[] var0, int[] var1, int var2, int var3, int var4,
  ...
  private static final void method670(int[] var0, int[] var1, int var2, int var3, int var4,
                                      int var5, int var6, int var7, int var8, int var9, int var10,
                                      int var11) {
    int var12 = var3;
