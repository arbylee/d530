final class NPC extends Mobile {
  ...
  static final int method1984(int var0, int var1, int var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var5, "km.S(" + var0 + ',' + var1 + ',' + var2 + ')');
    }
  }
      ...
      try {
        if (~SomethingQuickChatK.anInt154 == -3) {
          if (MidiSomething.aClass3_Sub27_1154 == null) {
            MidiSomething.aClass3_Sub27_1154 = MidiFile
              .method517(DummyClass55.aClass153_1423, TextureSampler8.anInt3463,
          ...
          if (DummyClass55.aClass3_Sub24_Sub4_1421
            .method470(MidiSomething.aClass3_Sub27_1154, -122, DummyClass23.aClass153_1661,
              SomethingQuickChat.aClass83_3579, 22050)) {
            ...
            DummyClass55.aClass3_Sub24_Sub4_1421
              .method490(AreaSoundEffect.aBoolean2311, MidiSomething.aClass3_Sub27_1154, 17774);
  ...
  final void draw(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
    ...
    try {
      if (this.config != null) {
        ...
        AbstractModel var15 = this.config
          .method1476(this.aClass145Array2809, this.anInt2793, (byte) -116, this.anInt2813,
            this.anInt2776, this.anInt2760, this.anInt2832, var14, this.anInt2802, var13);
        if (var15 != null) {
          ...
          if (Projectile.aBoolean2910 && var16.aBoolean1249) {
            var17 = GameObject
              .method1957(this.config.aByte1287, this.aBoolean2810, null == var14 ? var13 : var14,
                this.anInt2819, this.config.aShort1256, this.anInt2829, this.config.aShort1286,
                this.config.size, var15, var1, null != var14 ? this.anInt2813 : this.anInt2832,
                this.anInt2831, this.config.aByte1275, (byte) -49);
  ...
  final void setConfiguration(int var1, NpcConfiguration var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "km.R(" + var1 + ',' + (var2 != null ? "{...}" : "null") + ')');
    }
  }
