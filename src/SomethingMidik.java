...
final class SomethingMidik {
  private int anInt1937;
  private int anInt1938;
  private int anInt1939 = MidiInstrument.method368(16);
  ...
  SomethingMidik() {
    anInt1938 = MidiInstrument.method368(24);
    anInt1940 = MidiInstrument.method368(24);
    anInt1941 = MidiInstrument.method368(24) + 1;
    anInt1943 = MidiInstrument.method368(6) + 1;
    anInt1937 = MidiInstrument.method368(8);
    int[] is = new int[anInt1943];
    for (int i = 0; i < anInt1943; i++) {
      int i_0_ = 0;
      int i_1_ = MidiInstrument.method368(3);
      boolean bool = MidiInstrument.method364() != 0;
      if (bool) {
        i_0_ = MidiInstrument.method368(5);
      }
      is[i] = i_0_ << 3 | i_1_;
    }
    anIntArray1942 = new int[anInt1943 * 8];
    for (int i = 0; i < anInt1943 * 8; i++) {
      anIntArray1942[i] = ((is[i >> 3] & 1 << (i & 0x7)) != 0 ? MidiInstrument.method368(8) : -1);
    }
  }
  ...
  final void method2112(float[] fs, int i, boolean bool) {
    ...
    if (!bool) {
      int i_3_ = (MidiInstrument.aClass71Array2406[anInt1937].anInt1063);
      ...
      for (int i_6_ = 0; i_6_ < 8; i_6_++) {
        ...
        while (i_7_ < i_5_) {
          if (i_6_ == 0) {
            int i_8_ = MidiInstrument.aClass71Array2406[anInt1937].method1290();
          ...
          for (int i_10_ = 0; i_10_ < i_3_; i_10_++) {
            ...
            if (i_12_ >= 0) {
              ...
              SomethingMidiInstrument class71 = MidiInstrument.aClass71Array2406[i_12_];
              if (anInt1939 == 0) {
                int i_14_ = (anInt1941 / class71.anInt1063);
