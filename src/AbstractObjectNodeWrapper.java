abstract class AbstractObjectNodeWrapper {

  static GameString aClass94_1617 = SpawnedGameObject.createString(")1a2)1m");
  static GameString aClass94_1618 =
    SpawnedGameObject.createString("Verbindung zum Update)2Server hergestellt)3");
  static short[][] aShortArrayArray1619 = new short[][] {
    {
  ...
  static GameString aClass94_1620 = SpawnedGameObject.createString("Cach-B");
  static GameString aClass94_1621 = SpawnedGameObject.createString("Chargement des polices )2 ");
  ...
  static final void method1724(int var0, int var1, int var2, int var3, int var4, int var5,
                               byte var6, int var7) {
    try {
