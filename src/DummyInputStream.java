...
final class DummyInputStream extends InputStream {
  ...
  static final int[] method62(boolean var0, int var1, int var2, int var3, int var4, float var5,
                              int var6, int var7) {
    try {
      if (var1 != 14585) {
        anInt40 = 43;
  ...
  static final AbstractTextureSampler method63(byte var0, Buffer var1) {
    try {
