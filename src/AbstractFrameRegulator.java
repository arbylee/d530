abstract class AbstractFrameRegulator {
          ...
          if (var10 != 0) {
            ...
            TriChromaticImageCache.aClass3_Sub28_Sub16_Sub2_1381.pixels[var6++] =
              ClientScript.bitAnd(var13 * ClientScript.bitAnd(var11, 16711935)
                + ClientScript.bitAnd(16711935, var10) * var12, -16711936) - -ClientScript.bitAnd(
                ClientScript.bitAnd(var10, '\uff00') * var12 - -(
                  ClientScript.bitAnd('\uff00', var11) * var13), 16711680) >> 8;
          } else {
  ...
  static final void method1769(float[][] var0, byte[][] var1, byte[][] var2, Light[] var3, int var4,
            ...
            for (var23 = var21; ~var23 >= ~var22; ++var23) {
              ...
              if (var25 != 0) {
                if (~var43 != -1) {
                  ...
                  if (-1 == var46.anInt2103) {
                    TextureSampler18.method284(var0, var9, var23, var6, var19,
                      SceneSomething.anIntArrayArray499[var7[var23][var19]], var14, (byte) 116,
                ...
                if (var7[var23][var19] != 0) {
                  TextureSampler18.method284(var0, var9, var23, var6, var19,
                    DummyClass21.anIntArrayArray1763[var7[var23][var19]], var14, (byte) -88, var13,
