final class TextureSampler7 extends AbstractTextureSampler {

  static long serverCipherKey = 0L;
  static GameString aClass94_3339 = SpawnedGameObject.createString("null");
  static int cameraTileZ;
  static GameString[] aClass94Array3341 = new GameString[100];
  static int anInt3342;
  static GameString aClass94_3344 = SpawnedGameObject
    .createString("Sie k-Onnen sich selbst nicht selbst auf Ihre Ignorieren)2Liste setzen(Q");
  ...
  static final void method295(GameString var0, byte var1, int var2) {
    try {
  ...
  public static void method296(byte var0) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var2, "pi.F(" + var0 + ')');
    }
  }
  ...
  static final void method297(long var0, int var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var5, "pi.C(" + var0 + ',' + var2 + ')');
    }
  }

  static final SomethingGl0[] method298(byte[][][] var0, byte[][] var1, byte[][] var2, int[][] var3,
    ...
    try {
      ...
      for (var17 = 1; -103 <= ~var17; ++var17) {
        for (var56 = 1; 102 >= var56; ++var56) {
          if (0 != var2[var17][var56]) {
            ...
            if (null == var34) {
              var34 = new SomethingGl0(-1 + (var21 >> 16), (float) ('\uffff' & var21), false,
                null != var13, var20);
            ...
            if (~var27 != ~var25) {
              ...
              if (var34 == null) {
                var34 = new SomethingGl0((var22 >> 16) - 1, (float) ('\uffff' & var22), false,
                  null != var13, var20);
            ...
            if (~var29 != ~var25 && ~var29 != ~var27) {
              ...
              if (var34 == null) {
                var34 = new SomethingGl0((var23 >> 16) + -1, (float) ('\uffff' & var23), false,
                  null != var13, var20);
            ...
            if (~var31 != ~var25 && ~var27 != ~var31 && var31 != var29) {
              ...
              if (null == var34) {
                var34 = new SomethingGl0((var24 >> 16) - 1, (float) (var24 & '\uffff'), false,
                  null != var13, var20);
      ...
      for (var17 = 1; -103 <= ~var17; ++var17) {
        for (var56 = 1; -103 <= ~var56; ++var56) {
          ...
          if (0 != var57) {
            ...
            SceneSomething.method955(var13, var64 <= var64,
            ...
            if (var32 != var67) {
              ...
              SceneSomething.method955(var13, var62 <= var64,
                ...
                TextureSampler34.method190(var47, var40, (byte) -113, var44), var62 <= var62, var12,
            ...
            if (var70 != var67 && ~var70 != ~var32) {
              ...
              SceneSomething.method955(var13, ~var64 <= ~var63,
                ...
                var20, var17, var63 <= var63, var8, var63 <= var69, var14 ^ 4098, var4, var22,
            ...
            if (~var36 != ~var67 && ~var36 != ~var32 && var36 != var70) {
              ...
              SceneSomething.method955(var13, ~var69 >= ~var64,
                ...
                var20, var17, var69 <= var63, var8, ~var69 <= ~var69, var14 ^ 4098, var4, var22,
      ...
      throw AbstractGameWorld.cascadeException(var51,
        "pi.E(" + (var0 != null ? "{...}" : "null") + ',' + (var1 != null ? "{...}" : "null") + ','
          + (var2 != null ? "{...}" : "null") + ',' + (var3 != null ? "{...}" : "null") + ',' + (
          var4 != null ?
            "{...}" :
            "null") + ',' + (var5 != null ? "{...}" : "null") + ',' + (var6 != null ?
          "{...}" :
          "null") + ',' + (var7 != null ? "{...}" : "null") + ',' + (var8 != null ?
          "{...}" :
          "null") + ',' + var9 + ',' + (var10 != null ? "{...}" : "null") + ',' + (var11 != null ?
          "{...}" :
          "null") + ',' + (var12 != null ? "{...}" : "null") + ',' + (var13 != null ?
          "{...}" :
          "null") + ',' + var14 + ')');
    }
  }
  ...
  static final void method299(int var0, int var1, int var2) {
    try {
      ...
      TextureSampler12.secureBuffer
        .method790(GameObjectConfig.aBooleanArray1490[82] ? 1 : 0, -13071);
      ...
      for (int var6 = 1; var3 > var6; ++var6) {
        --var1;
        TextureSampler12.secureBuffer
          .method790(-var4 + TextureSampler38.anIntArray3456[var1], -13071);
        TextureSampler12.secureBuffer.method743(10213, DummyClass38.anIntArray729[var1] + -var5);
      }

    } catch (RuntimeException var7) {
      throw AbstractGameWorld
        .cascadeException(var7, "pi.O(" + var0 + ',' + var1 + ',' + var2 + ')');
    }
  }
  ...
  final int[] method154(int var1, byte var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var9, "pi.D(" + var1 + ',' + var2 + ')');
    }
  }
  ...
  final int[][] method166(int var1, int var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var22, "pi.T(" + var1 + ',' + var2 + ')');
    }
  }
