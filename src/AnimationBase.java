final class AnimationBase {
  ...
  int anInt1383 = -1;
  AnimationFrame aClass3_Sub17_1384 = null;
  ...
  AnimationBase(byte[] var1, AnimationFrame var2) {
    ...
    for (var9 = 0; var9 < var5; ++var9) {
      ...
      if (var11 > 0) {
        ...
        if ((var11 & 1) != 0) {
          aShortArray1394[var6] = (short) var4.readUnsignedSmart();
        } else {
          aShortArray1394[var6] = var12;
        }

        if ((var11 & 2) != 0) {
          aShortArray1391[var6] = (short) var4.readUnsignedSmart();
        } else {
          aShortArray1391[var6] = var12;
        }

        if ((var11 & 4) != 0) {
          aShortArray1390[var6] = (short) var4.readUnsignedSmart();
        } else {
        ...
        if (var10 == 2) {
          aShortArray1394[var6] =
            (short) (((aShortArray1394[var6] & 255) << 3) + (aShortArray1394[var6] >> 8 & 7));
          aShortArray1391[var6] =
            (short) (((aShortArray1391[var6] & 255) << 3) + (aShortArray1391[var6] >> 8 & 7));
          aShortArray1390[var6] =
            (short) (((aShortArray1390[var6] & 255) << 3) + (aShortArray1390[var6] >> 8 & 7));
        }
