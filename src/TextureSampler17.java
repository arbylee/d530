final class TextureSampler17 extends AbstractTextureSampler {

  static Deque stillGraphics = new Deque();
  static int sceneHeight;
  static int[] updatedMapIds;
  static GameString COMMAND_WM3 = SpawnedGameObject.createString("::wm3");
  ...
  public static void method241(byte var0) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var2, "hk.B(" + var0 + ')');
    }
  }
  ...
  private final void method239(int var1, int var2, int var3, int var4) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var15, "hk.C(" + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ')');
    }
  }
  ...
  private final void method240(byte var1, int var2, int var3, int var4) {
    try {
      ...
      if (-1 > ~this.anInt3188 && 4096 > this.anInt3188) {
        this.anInt3189 =
          (var7 << 12) / (this.anInt3188 > 2048 ? 8192 - 2 * this.anInt3188 : this.anInt3188 * 2);
      } else {
        this.anInt3189 = 0;
      }
      ...
      throw AbstractGameWorld
        .cascadeException(var11, "hk.E(" + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ')');
    }
  }
  ...
  final int[][] method166(int var1, int var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var12, "hk.T(" + var1 + ',' + var2 + ')');
    }
  }
