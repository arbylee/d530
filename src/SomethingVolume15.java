final class SomethingVolume15 extends Node {

  static int anInt2421 = -1;
  static int anInt2426;
  static boolean aBoolean2427 = false;
  static ObjectCache aClass93_2428 = new ObjectCache(50);
  static SocketStream gameSocket;
  static GameString COMMAND_TWEEN = SpawnedGameObject.createString("::tween");
  ...
  byte[] aByteArray2425;
  byte[] aByteArray2430;
  SomethingMusic0[] aClass3_Sub12_Sub1Array2431;
  short[] aShortArray2434;
  SomethingIndex150[] aClass166Array2435;
  ...
  SomethingVolume15(byte[] var1) {
    try {
      ...
      Buffer var2;
      for (var2 = new Buffer(var1); -1 != ~var2.bytes[var3 + var2.position]; ++var3) {
      }
      ...
      int var6;
      for (var6 = 0; 0 != var2.bytes[var2.position + var6]; ++var6) {
      }
      ...
      for (var2.position += var6; -1 != ~var2.bytes[var9 + var2.position]; ++var9) {
      }
  ...
  static final SomethingWorldMapy method371(int var0, GameString var1) {
    try {
      if (var0 != 2) {
        method372(false);
      }
  ...
  static final void method374(int var0, boolean var1, byte[] var2, int var3, int var4,
                              CollisionMap[] var5) {
    try {
      ...
      while (true) {
        ...
        while (true) {
          int var10 = var6.readUnsignedSmart(true);
          if (-1 == ~var10) {
            break;
          }
