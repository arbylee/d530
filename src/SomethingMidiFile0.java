final class SomethingMidiFile0 {

  private static byte[] aByteArray1117 = new byte[] {
  ...
  int[] anIntArray1114;
  int anInt1116;
  private Buffer aClass3_Sub30_1113 = new Buffer((byte[]) null);
  ...
  private final int method1379(int var1) {
    ...
    if (var5 != 240 && var5 != 247) {
      ...
      if (var5 == 247 && var3 > 0) {
        int var4 = this.aClass3_Sub30_1113.bytes[this.aClass3_Sub30_1113.position] & 255;
