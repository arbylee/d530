...
public final class GameClient extends GameStub {
  ...
  private final void updateGame(byte var1) {
    try {
      ...
      if (-1 != InventoryConfig.anInt3655) {
        SpotAnimationConfig.method967(0, 0, 2, 0, DummyClass30.viewWidth, InventoryConfig.anInt3655,
          ...
          if (null != var4) {
            ...
            if ((var5 & 2) > 0 && -1 == ~var4.anInt2816 && 10.0D > Math.random() * 1000.0D) {
              ...
              if (var6 != 0 || 0 != var7) {
                ...
                BlockConfig.collisionMaps[GameWorldSomething.currentPlane].method1502(var1 + 20850,
                  var4.anInt2819 >> -649292601, var4.getSize(), false, 0, var4.getSize(),
                  var4.anInt2829 >> 1442151015);
                if (0 <= var4.waypointsX[0] && var4.waypointsX[0] <= 104 + -var4.getSize()
                  && 0 <= var4.waypointsY[0] && var4.waypointsY[0] <= 104 - var4.getSize()
                  && BlockConfig.collisionMaps[GameWorldSomething.currentPlane].method1500(-2,
                  var4.anInt2829 >> 2135388679, var4.waypointsY[0], var4.waypointsX[0],
                  var4.anInt2819 >> 627928135)) {
                  if (var4.getSize() > 1) {
            ...
            BlockConfig.collisionMaps[GameWorldSomething.currentPlane].method1489(
              var4.anInt2819 >> -375465785, false, (byte) 85, var4.anInt2829 >> 1678486439,
      ...
      if (HintMarker.loadingState == 0) {
        ...
        if (~HintMarker.loadingState == -11) {
          ...
          if (AbstractFileRequester.fileSystem.isUpdateTableReceived()) {
            ...
            ClanChatUser.midiInstruments = FileSystem.createUnpacker(false, false, true, 14, true);
          ...
          if (~HintMarker.loadingState == -46) {
            ...
            GameWorld.audioOutputStream0 =
              DummyClass43.createAudioOutputStream(22050, DummyClass35.signLink,
                InventoryConfig.canvas, 0, 14);
            GameWorld.audioOutputStream0.method2154(-116, BlockConfig.aClass3_Sub24_Sub4_1193);
            RenderAnimation.method897(17770, BlockConfig.aClass3_Sub24_Sub4_1193,
              NPC.fileUnpacker15, ClanChatUser.midiInstruments, AbstractMouseWheel.soundEffects);
            SomethingWorldMappy.audioOutputStream1 =
              DummyClass43.createAudioOutputStream(2048, DummyClass35.signLink,
                InventoryConfig.canvas, 1, 14);
              ...
              if (~HintMarker.loadingState != -66) {
                if (HintMarker.loadingState != 70) {
                  if (HintMarker.loadingState == 80) {
                    ...
                    if (HintMarker.loadingState == 100) {
                      ...
                      if (~HintMarker.loadingState != -121) {
                              ...
                              if (FileUnpacker.fileUnpacker13.method2113((byte) 89)) {
                                if (SomethingPacket116.worldMapData.method2127((byte) -83,
                                  ...
                                  SomethingTexture4.method1353(
                                    TextureCache.aClass3_Sub28_Sub16_Sub2Array2140, -11931,
                                  ...
                                  AnimationFrame.loadingText =
                                    RenderAnimation.concat(new GameString[] {
                                      ...
                                      SomethingPacket116.worldMapData.method2116(22813,
                                        DummyClass53.aClass94_1342) / 10)), IdentityKit.aClass94_468
                                    });
                        ...
                        GroundItemNode.EMPTY_STRING, (byte) 116, Texture.aClass94_3792)) {
                        HuffmanEncoder var9 = new HuffmanEncoder(
                          TextureSampler28.fileUnpacker10.method2123(0, GroundItemNode.EMPTY_STRING,
                  ...
                  if (~var2 <= -1101) {
                    ...
                    DummyClass58.method1661(2, FloorOverlay.fileUnpacker16, DummyClass13.models,
                      true);
                    ...
                    TextureSampler9.method205(SpawnedGameObject.fileUnpacker25, 115,
                    ...
                    BufferObject.method2065((byte) -125, Something3dRoot.configs,
                      Projectile.sprites);
                    DummyClass56.method1645(Something3dRoot.configs, Projectile.sprites,
                      (byte) -67);
    ...
    try {
      if (~DummyClass15.state != -1001) {
        ...
        if ((-31 == ~DummyClass15.state || -11 == ~DummyClass15.state) && (
          ...
          SceneNode.setWindowMode(AnimationSomething.replaceCanvas, MidiSomething.getWindowMode(),
            -8914, AbstractTextureSampler.anInt2378, TextureSampler21.anInt3071);
        }
  ...
  static final WidgetAccess method44(Widget var0) {
    WidgetAccess var1 = (WidgetAccess) DummyClass23.aClass130_1659.get(
      ((long) var0.anInt279 << 32) + (long) var0.anInt191);
    ...
    try {
      ...
      if (var2 == null) {
        byte[] var3 = AnimationSequence.animationSequences.getBytes(
          AbstractFrameRegulator.method1765(id, -1732504441), MouseRecorder.method1262(117, id));
  ...
  public static final void main(String[] args) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var5,
        "GameClient.main(" + (args != null ? "{...}" : "null") + ')');
    }
  }
      ...
      if (var9 != null && var9.anInt190 == var1 && (!var9.aBoolean233 || var9.anInt187 == 0
        ...
        if (!var9.aBoolean233 || var12 < var14 && var13 < var15) {
              ...
              for (var19 = 0; var19 < var9.aByteArray263.length; ++var19) {
                if (!GameObjectConfig.aBooleanArray1490[var9.aByteArray263[var19]]) {
                  ...
                  if (var20 == 0
                    ...
                    DummyOutputStream.method66(GroundItemNode.EMPTY_STRING, -1, var19 + 1,
          ...
          if (var9.anInt187 == 0) {
            ...
            if (var28 != null) {
              SpotAnimationConfig.method967(var10, var13, 2, var11, var14, var28.anInt2602, var12,
                var15);
            }
          }
        }
