final class FilterPossibly {
  ...
  final int method1622(int var1, float var2) {
    float var3;
    if (var1 == 0) {
      var3 = (float) this.anIntArray1437[0]
        + (float) (this.anIntArray1437[1] - this.anIntArray1437[0]) * var2;
      var3 *= 0.0030517578F;
    ...
    if (this.anIntArray1434[var1] == 0) {
      ...
      aFloatArrayArray1431[var1][0] =
        -2.0F * var3 * (float) Math.cos((double) this.method1625(var1, 0, var2));
      ...
      for (var4 = 1; var4 < this.anIntArray1434[var1]; ++var4) {
        ...
        aFloatArrayArray1431[var1][var4 * 2] = aFloatArrayArray1431[var1][var4 * 2 - 1] * var5
          + aFloatArrayArray1431[var1][var4 * 2 - 2] * var6;

        for (int var7 = var4 * 2 - 1; var7 >= 2; --var7) {
          aFloatArrayArray1431[var1][var7] += aFloatArrayArray1431[var1][var7 - 1] * var5
            + aFloatArrayArray1431[var1][var7 - 2] * var6;
        }
  ...
  private final float method1624(int var1, int var2, float var3) {
    float var4 = (float) this.anIntArrayArrayArray1432[var1][0][var2] + var3 * (float) (
  ...
  private final float method1625(int var1, int var2, float var3) {
    float var4 = (float) this.anIntArrayArrayArray1430[var1][0][var2] + var3 * (float) (
