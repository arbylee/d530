...
final class GlFont extends AbstractFont {
  ...
  GlFont(byte[] var1, int[] var2, int[] var3, int[] var4, int[] var5, byte[][] var6) {
  ...
  final void method678(int var1, int var2, int var3, int var4, int var5, int var6, boolean var7) {
    ...
    if (GlUtils.aClass3_Sub28_Sub16_Sub1_447 != null) {
      ...
      var8.glTranslatef((float) var2, (float) (GlRenderer.viewHeight - var3), 0.0F);
      ...
      var8.glEnable(3553);
      var8.glBindTexture(3553, var13.textureId);
      var8.glTexEnvi(8960, '\u8571', 7681);
      var8.glTexEnvi(8960, '\u8580', '\u8578');
      float var14 = (float) (var2 - GlUtils.anInt449) / (float) var13.anInt4075;
      float var15 = (float) (var3 - GlUtils.anInt448) / (float) var13.anInt4079;
      float var16 = (float) (var2 + var4 - GlUtils.anInt449) / (float) var13.anInt4075;
      float var17 = (float) (var3 + var5 - GlUtils.anInt448) / (float) var13.anInt4079;
      var8.glBegin(6);
  ...
  final void method679(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
    ...
    GlRenderer.bindTexture(this.anInt4084);
    var9.glColor4ub((byte) (var6 >> 16), (byte) (var6 >> 8), (byte) var6,
      var7 > 255 ? -1 : (byte) var7);
    var9.glTranslatef((float) var2, (float) (GlRenderer.viewHeight - var3), 0.0F);
