abstract class AbstractModel extends SceneNode {
  ...
  private final void somethingAnimation(AnimationFrame var1, AnimationBase var2, AnimationBase var3,
        ...
        if (var36 || var15) {
          if (var6 != null && var6[var35] != var7 && var1.anIntArray2466[var35] != 0) {
            ...
            if (var21 != -1) {
              ...
              if (var31 != '\uffff') {
                this.applyAnimationFrame(0, var1.anIntArrayArray2460[var21], 0, 0, 0, var8, var31,
                  var10);
              } else {
              ...
              if (var31 != '\uffff') {
                this.applyAnimationFrame(0, var1.anIntArrayArray2460[var26], 0, 0, 0, var8, var31,
                  var10);
              } else {
            ...
            if (var31 != '\uffff') {
              this.applyAnimationFrame(var17, var1.anIntArrayArray2460[var35], var28, var29, var30,
                var8, var31, var10);
            } else {
      ...
      for (var11 = 0; var11 < var2.anInt1383; ++var11) {
        ...
        if (var6 == null || var6[var12] == var7 || var1.anIntArray2466[var12] == 0) {
          ...
          if (var13 != -1) {
            ...
            if (var14 != '\uffff') {
              this.applyAnimationFrame(0, var1.anIntArrayArray2460[var13], 0, 0, 0, var8, var14,
                var10);
            } else {
          ...
          if (var14 != '\uffff') {
            this.applyAnimationFrame(var1.anIntArray2466[var12], var1.anIntArrayArray2460[var12],
              var2.aShortArray1388[var11], var2.aShortArray1396[var11], var2.aShortArray1395[var11],
              var8, var14, var10);
          } else {
            this.method1891(var1.anIntArray2466[var12], var1.anIntArrayArray2460[var12],
              var2.aShortArray1388[var11], var2.aShortArray1396[var11], var2.aShortArray1395[var11],
              var8);
          }
        }
  ...
  final void method1877(AnimationSomething var1, int var2) {
    if (var2 != -1) {
      if (this.method1873()) {
  ...
  final void method1880(AnimationSomething var1, int var2, AnimationSomething var3, int var4,
  ...
  abstract AbstractModel method1882(boolean var1, boolean var2, boolean var3);

  abstract int method1883();

  abstract int method1884();

  abstract void rotateQuarterY();

  abstract void method1886(int var1);

  final void method1887(AnimationSomething var1, int var2, AnimationSomething var3, int var4,
                        int var5, int var6, int var7, boolean var8, int[] var9) {
    if (var2 != -1) {
      if (this.method1873()) {
  ...
  final void method1892(AnimationSomething var1, int var2, AnimationSomething var3, int var4,
                        int var5, int var6, AnimationSomething var7, int var8,
                        AnimationSomething var9, int var10, int var11, int var12, boolean[] var13,
                        boolean var14) {
    if (var2 != -1) {
  ...
  abstract void draw(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
                     long var8);
