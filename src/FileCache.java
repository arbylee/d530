...
final class FileCache {
  ...
  static ObjectCache aClass93_684 = new ObjectCache(64);
  static int anInt685;
  static int[] anIntArray686 = new int[2];
  static int anInt688 = 0;
  static int fogOffset;
  private BufferedFile aClass30_681 = null;
  private int anInt682;
  private BufferedFile aClass30_683 = null;
  private int anInt687 = '\ufde8';


  FileCache(int var1, BufferedFile var2, BufferedFile var3, int var4) {
    try {
      this.anInt687 = var4;
    ...
    try {
      ...
      synchronized (var3) {
        ...
        try {
          ...
          this.aClass30_683.seek(-35, (long) (6 * var1));
          ...
          if (0 < var5 && ~((long) var5) >= ~(this.aClass30_681.method976(0) / 520L)) {
            ...
            for (int var9 = 0; ~var8 > ~var4; var5 = var13) {
              ...
              int var10 = -var8 + var4;
              this.aClass30_681.seek(-113, (long) (520 * var5));
              if (-513 > ~var10) {
                var10 = 512;
              }

              this.aClass30_681.method978(0, DummyClass11.aByteArray2040, 8 + var10, 0);
      ...
      synchronized (var6) {
        try {
          ...
          if (var5) {
            ...
            this.aClass30_683.seek(-116, (long) (6 * var3));
            this.aClass30_683.method978(0, DummyClass11.aByteArray2040, 6, 0);
          ...
          this.aClass30_683.seek(-14, (long) (var3 * 6));
          this.aClass30_683.write(DummyClass11.aByteArray2040, 0, var1 ^ -903171097, 6);
          ...
          while (true) {
            if (~var8 > ~var2) {
              label146:
              {
                ...
                int var11;
                if (var5) {
                  this.aClass30_681.seek(-116, (long) (520 * var7));

                  try {
                    this.aClass30_681.method978(0, DummyClass11.aByteArray2040, 8, 0);
                ...
                this.aClass30_681.seek(var1 + -128, (long) (var7 * 520));
                var7 = var10;
                this.aClass30_681.write(DummyClass11.aByteArray2040, 0, -903171152, 8);
