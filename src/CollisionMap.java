final class CollisionMap {
  ...
  static GameString[] playerOptions = new GameString[8];
  static GameString aClass94_1301 = SpawnedGameObject.createString("(U3");
  static int anInt1302 = 0;
  static SomethingFont aClass33_1305;
  ...
  CollisionMap(int var1, int var2) {
    try {
      this.anInt1303 = var2;
      this.anInt1306 = 0;
      this.anInt1309 = 0;
  ...
  private final boolean method1487(int var1, int var2, int var3, int var4, int var5, int var6,
  ...
  final boolean method1488(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7,
                           int var8) {
    try {
      if (1 != var7) {
        if (var2 <= var5 && var2 + var7 + -1 >= var5 && var1 <= var1 && ~var1 >= ~(var7 + var1
          + -1)) {
          return true;
        }
        ...
        if (1 == var7) {
          if (0 == var6) {
            if (~var8 == -1) {
              ...
              if (~var5 == ~var2 && -1 + var1 == var4 && 0 == (this.anIntArrayArray1304[var2][var4]
                & 19661058)) {
                return true;
              }
            } else if (1 != var8) {
              if (var8 == 2) {
                ...
                if (~var5 == ~var2 && var4 == 1 + var1
                  && ~(this.anIntArrayArray1304[var2][var4] & 19661088) == -1) {
                  return true;
                }

                if (var5 == var2 && ~(var1 - 1) == ~var4
                  && ~(this.anIntArrayArray1304[var2][var4] & 19661058) == -1) {
                  return true;
                }
              } else if (var8 == 3) {
                if (var2 == var5 && ~(var1 + -1) == ~var4) {
                ...
                if (-1 + var5 == var2 && ~var1 == ~var4 && -1 == ~(
                  this.anIntArrayArray1304[var2][var4] & 19661064)) {
                  return true;
                }

                if (~(var5 - -1) == ~var2 && var4 == var1
                  && ~(this.anIntArrayArray1304[var2][var4] & 19661184) == -1) {
                  return true;
                }
              }
            } else {
              ...
              if (var5 + -1 == var2 && ~var1 == ~var4 && 0 == (this.anIntArrayArray1304[var2][var4]
                & 19661064)) {
                return true;
              }
          ...
          if (2 == var6) {
            if (var8 != 0) {
              if (~var8 == -2) {
                if (var2 == var5 + -1 && var1 == var4 && 0 == (this.anIntArrayArray1304[var2][var4]
                  & 19661064)) {
                  return true;
                }
                ...
                if (~var5 == ~var2 && var4 == -1 + var1 && -1 == ~(19661058
                ...
                if (~var8 == -4) {
                  ...
                  if (~var2 == ~var5 && var1 + 1 == var4 && 0 == (19661088
                    & this.anIntArrayArray1304[var2][var4])) {
                    return true;
                  }

                  if (~var2 == ~(var5 - -1) && var1 == var4
                    && ~(19661184 & this.anIntArrayArray1304[var2][var4]) == -1) {
                    return true;
                  }
                ...
                if (var2 == -1 + var5 && ~var1 == ~var4
                  && ~(this.anIntArrayArray1304[var2][var4] & 19661064) == -1) {
                  return true;
                }
          ...
          if (9 == var6) {
            ...
            if (var2 == -1 + var5 && ~var4 == ~var1 && -1 == ~(this.anIntArrayArray1304[var2][var4]
              & 8)) {
              return true;
            }

            if (var5 - -1 == var2 && ~var1 == ~var4
              && ~(this.anIntArrayArray1304[var2][var4] & 128) == -1) {
              return true;
            }
          }
        } else {
          ...
          if (~var6 == -1) {
            if (0 == var8) {
              ...
              if (var2 <= var5 && ~var9 <= ~var5 && ~(1 + var1) == ~var4 && 0 == (
                this.anIntArrayArray1304[var5][var4] & 19661088)) {
                return true;
              }
              ...
              if (~var2 == ~(var5 - var7) && ~var4 >= ~var1 && ~var10 <= ~var1
                && ~(this.anIntArrayArray1304[var9][var1] & 19661064) == -1) {
                return true;
              }

              if (~var2 == ~(var5 + 1) && var4 <= var1 && var10 >= var1 && 0 == (
                this.anIntArrayArray1304[var2][var1] & 19661184)) {
                return true;
              }
            } else if (2 != var8) {
              if (3 == var8) {
                ...
                if (var2 == var5 - var7 && var1 >= var4 && ~var10 <= ~var1
                  && ~(19661064 & this.anIntArrayArray1304[var9][var1]) == -1) {
                  return true;
                }
              ...
              if (~var5 <= ~var2 && ~var9 <= ~var5 && ~var4 == ~(1 + var1)
                && ~(this.anIntArrayArray1304[var5][var4] & 19661088) == -1) {
                return true;
              }

              if (~var5 <= ~var2 && ~var9 <= ~var5 && ~(var1 - var7) == ~var4 && 0 == (19661058
                & this.anIntArrayArray1304[var5][var10])) {
                return true;
              }
            }
          }
            ...
            if (~var8 != -1) {
              if (~var8 != -2) {
                if (-3 == ~var8) {
                  ...
                  if (~var2 >= ~var5 && var5 <= var9 && 1 + var1 == var4 && -1 == ~(
                    this.anIntArrayArray1304[var5][var4] & 19661088)) {
                    return true;
                  }

                  if (var2 == 1 + var5 && ~var1 <= ~var4 && var1 <= var10
                    && ~(this.anIntArrayArray1304[var2][var1] & 19661184) == -1) {
                    return true;
                  }
                ...
                if (~var5 <= ~var2 && ~var5 >= ~var9 && var4 == -var7 + var1
                  && ~(this.anIntArrayArray1304[var5][var10] & 19661058) == -1) {
                  return true;
                }
              }
            } else {
              ...
              if (~(1 + var5) == ~var2 && var1 >= var4 && var1 <= var10 && 0 == (
                this.anIntArrayArray1304[var2][var1] & 19661184)) {
                return true;
              }

              if (~var5 <= ~var2 && var9 >= var5 && -var7 + var1 == var4
                && ~(19661058 & this.anIntArrayArray1304[var5][var10]) == -1) {
                return true;
              }
            }
          }
          ...
          if (-10 == ~var6) {
            ...
            if (~var5 <= ~var2 && ~var5 >= ~var9 && ~var4 == ~(var1 - var7) && -1 == ~(19661058
              & this.anIntArrayArray1304[var5][var10])) {
              return true;
            }
            ...
            if (~var2 == ~(1 + var5) && ~var1 <= ~var4 && var10 >= var1 && -1 == ~(
              this.anIntArrayArray1304[var2][var1] & 19661184)) {
              return true;
            }
          }
      ...
      throw AbstractGameWorld.cascadeException(var11,
        "mj.D(" + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ',' + var5 + ',' + var6 + ',' + var7
          + ',' + var8 + ')');
    }
  }
  ...
  final boolean method1492(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
                           int var8) {
    try {
      if (-2 == ~var5) {
      ...
      } else if (~var7 >= ~var3 && ~(-1 + var5 + var7) <= ~var3 && var1 <= var1
        && -1 + var1 + var5 >= var1) {
        return true;
      }
      ...
      if (~var5 == -2) {
        if (6 == var2 || var2 == 7) {
          ...
          if (var6 == 0) {
            if (~var7 == ~(1 + var3) && var1 == var4
              && ~(this.anIntArrayArray1304[var7][var4] & 128) == -1) {
              return true;
            }
            ...
            if (var7 == var3 + -1 && ~var1 == ~var4 && -1 == ~(this.anIntArrayArray1304[var7][var4]
              & 8)) {
              return true;
            }

            if (var3 == var7 && var4 == -1 + var1 && -1 == ~(2
            ...
            if (~var7 == ~(var3 - 1) && ~var4 == ~var1 && 0 == (8
              & this.anIntArrayArray1304[var7][var4])) {
              return true;
            }

            if (var3 == var7 && ~(1 + var1) == ~var4 && -1 == ~(32
              & this.anIntArrayArray1304[var7][var4])) {
              return true;
            }
          }
        ...
        if (-9 == ~var2) {
          ...
          if (-1 + var3 == var7 && var4 == var1 && 0 == (8
            & this.anIntArrayArray1304[var7][var4])) {
            return true;
          }

          if (~var7 == ~(var3 - -1) && var1 == var4
            && ~(128 & this.anIntArrayArray1304[var7][var4]) == -1) {
            return true;
          }
        }
      } else {
        ...
        if (6 == var2 || var2 == 7) {
          ...
          if (~var6 != -1) {
            if (var6 == 1) {
              if (~(-var5 + var3) == ~var7 && var1 >= var4 && ~var10 <= ~var1 && -1 == ~(8
                & this.anIntArrayArray1304[var9][var1])) {
                return true;
              }

              if (~var3 <= ~var7 && ~var9 <= ~var3 && var1 + -var5 == var4 && 0 == (
                this.anIntArrayArray1304[var3][var10] & 2)) {
                return true;
              }
            } else if (-3 != ~var6) {
              if (var6 == 3) {
                ...
                if (~var3 <= ~var7 && ~var3 >= ~var9 && var4 == var1 - -1 && 0 == (
                  this.anIntArrayArray1304[var3][var4] & 32)) {
                  return true;
                }
              }
            } else {
              if (~var7 == ~(-var5 + var3) && var1 >= var4 && ~var1 >= ~var10 && -1 == ~(8
                & this.anIntArrayArray1304[var9][var1])) {
                return true;
              }

              if (var7 <= var3 && var3 <= var9 && ~var4 == ~(var1 + 1) && 0 == (32
                & this.anIntArrayArray1304[var3][var4])) {
                return true;
              }
            }
          } else {
            if (~(1 + var3) == ~var7 && ~var4 >= ~var1 && var1 <= var10 && -1 == ~(
              this.anIntArrayArray1304[var7][var1] & 128)) {
              return true;
            }

            if (~var3 <= ~var7 && var9 >= var3 && ~(var1 + -var5) == ~var4
              && ~(2 & this.anIntArrayArray1304[var3][var10]) == -1) {
              return true;
            }
          }
        }
        ...
        if (var2 == 8) {
          if (var7 <= var3 && var9 >= var3 && var4 == 1 + var1 && -1 == ~(
            this.anIntArrayArray1304[var3][var4] & 32)) {
            return true;
          }
          ...
          if (var7 == -var5 + var3 && var4 <= var1 && ~var10 <= ~var1
            && ~(this.anIntArrayArray1304[var9][var1] & 8) == -1) {
            return true;
          }

          if (~var7 == ~(1 + var3) && var1 >= var4 && var1 <= var10 && 0 == (
            this.anIntArrayArray1304[var7][var1] & 128)) {
            return true;
          }
        }
  ...
  private final boolean method1494(int var1, int var2, int var3, int var4, boolean var5, int var6,
    ...
    try {
        ...
        if (var7 >= var1 && var7 < var13) {
          if (var12 == var2 && ~(4 & var4) == -1) {
            ...
            for (var16 = var13 >= var11 ? var11 : var13; var16 > var15; ++var15) {
              if (0 == (
                this.anIntArrayArray1304[-this.anInt1309 + var15][var12 - (this.anInt1306 + 1)]
                  & 2)) {
                return true;
              }
            }
            ...
            for (var16 = ~var11 < ~var13 ? var13 : var11; ~var16 < ~var15; ++var15) {
              if ((32 & this.anIntArrayArray1304[var15 - this.anInt1309][var8 + -this.anInt1306])
                == 0) {
                return true;
              }
            }
          ...
          if (~var2 == ~var12 && 0 == (4 & var4)) {
            for (var15 = var1; ~var11 < ~var15; ++var15) {
              if ((2 & this.anIntArrayArray1304[-this.anInt1309 + var15][var12 - (this.anInt1306
                + 1)]) == 0) {
                return true;
              }
            }
            ...
            for (var15 = var1; var11 > var15; ++var15) {
              if (~(32 & this.anIntArrayArray1304[-this.anInt1309 + var15][-this.anInt1306 + var8])
                == -1) {
                return true;
              }
            }
          ...
          if (var11 == var1 && 0 == (8 & var4)) {
            ...
            for (var16 = ~var14 <= ~var12 ? var12 : var14; ~var15 > ~var16; ++var15) {
              if (~(8 & this.anIntArrayArray1304[-1 + -this.anInt1309 + var11][var15
                - this.anInt1306]) == -1) {
                return true;
              }
            }
            ...
            for (var16 = var14 < var12 ? var14 : var12; ~var15 > ~var16; ++var15) {
              if ((this.anIntArrayArray1304[-this.anInt1309 + var7][-this.anInt1306 + var15] & 128)
                == 0) {
                return true;
              }
            }
          ...
          if (~var11 == ~var1 && (var4 & 8) == 0) {
            for (var15 = var2; var12 > var15; ++var15) {
              if (-1 == ~(
                this.anIntArrayArray1304[-this.anInt1309 + var11 + -1][-this.anInt1306 + var15]
                  & 8)) {
                return true;
              }
            }
            ...
            for (var15 = var2; ~var15 > ~var12; ++var15) {
              if (-1 == ~(128 & this.anIntArrayArray1304[var7 + -this.anInt1309][-this.anInt1306
                + var15])) {
                return true;
              }
            }
      ...
      throw AbstractGameWorld.cascadeException(var17,
        "mj.O(" + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ',' + var5 + ',' + var6 + ',' + var7
          + ',' + var8 + ',' + var9 + ',' + var10 + ')');
    }
  }
  ...
  final boolean method1498(boolean var1, int var2, int var3, int var4, int var5, int var6, int var7,
                           int var8, int var9) {
    try {
      if (-2 > ~var5) {
        return this.method1487(var5, var6, var2, var9, var3, var8, var5, var4, (byte) -125) ?
          true :
          this.method1494(var2, var8, var6, var7, true, var9, var4, var3, var5, var5);
      } else {
        ...
        if (~var2 >= ~var4 && var10 >= var4 && var8 <= var3 && ~var3 >= ~var11) {
          ...
          return var2 + -1 == var4 && ~var3 <= ~var8 && var3 <= var11 && -1 == ~(
            this.anIntArrayArray1304[-this.anInt1309 + var4][var3 - this.anInt1306] & 8) && -1 == ~(
            var7 & 8) ?
            true :
            (var4 == 1 + var10 && ~var8 >= ~var3 && ~var11 <= ~var3 && 0 == (128
              & this.anIntArrayArray1304[var4 - this.anInt1309][-this.anInt1306 + var3])
              && (var7 & 2) == 0 ?
              true :
              (~var3 == ~(var8 - 1) && ~var2 >= ~var4 && var10 >= var4
                && (2 & this.anIntArrayArray1304[-this.anInt1309 + var4][-this.anInt1306 + var3])
                == 0 && -1 == ~(4 & var7) ?
                true :
                ~var3 == ~(1 + var11) && var4 >= var2 && ~var10 <= ~var4
                  && ~(32 & this.anIntArrayArray1304[var4 - this.anInt1309][var3 + -this.anInt1306])
                  == -1 && -1 == ~(var7 & 1)));
        }
      }
