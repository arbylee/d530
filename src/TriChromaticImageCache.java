final class TriChromaticImageCache {

  static GameString aClass94_1363 = SpawnedGameObject.createString("Clientscript error in: ");
  static byte[] aByteArray1364 = new byte['\u8080'];
  static FileUnpacker aClass153_1370;
  static FileUnpacker aClass153_1372;
  static int[][] anIntArrayArray1373;
  static GameString aClass94_1374;
  static int cameraTileX;
  static FileUnpacker materials;
  static GameString aClass94_1377;
  static FileUnpacker aClass153_1378;
  static GameString aClass94_1380;
  static SoftwareDirectColorSprite aClass3_Sub28_Sub16_Sub2_1381;
  ...
  static {
    ...
    aClass94_1374 = SpawnedGameObject.createString("zap");
    aClass94_1377 = SpawnedGameObject.createString("Abbrechen");
    anIntArrayArray1373 = new int[104][104];
    aClass94_1380 = SpawnedGameObject.createString(")4p=");
  }
  ...
  TriChromaticImageCache(int var1, int var2, int var3) {
    try {
      this.anInt1369 = var2;
      this.anInt1367 = var1;
