...
final class SomethingFont {

  private static String aString597 =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
      + String.valueOf('\u00c4') + '\u00cb' + '\u00cf' + '\u00d6' + '\u00dc' + '\u00e4' + '\u00eb'
      + '\u00ef' + '\u00f6' + '\u00fc' + '\u00ff' + '\u00df' + '\u00c1' + '\u00c0' + '\u00c9'
      + '\u00c8' + '\u00cd' + '\u00cc' + '\u00d3' + '\u00d2' + '\u00da' + '\u00d9' + '\u00e1'
      + '\u00e0' + '\u00e9' + '\u00e8' + '\u00ed' + '\u00ec' + '\u00f3' + '\u00f2' + '\u00fa'
      + '\u00f9' + '\u00c2' + '\u00ca' + '\u00ce' + '\u00d4' + '\u00db' + '\u00e2' + '\u00ea'
  ...
  SomethingFont(int var1, boolean bold, Component var3) {
  ...
  private final void method1000(int[] var1, byte[] var2, int var3, int var4, int var5, int var6,
  ...
  private final void method1002(int[] var1, byte[] var2, int var3, int var4, int var5, int var6,
                                int var7, int var8, int var9) {
    int var10 = -(var6 >> 2);
    var6 = -(var6 & 3);
  ...
  final void method1003(GameString var1, int var2, int var3, int var4, boolean var5) {
  ...
  private final void method1004(Font var1, FontMetrics var2, char var3, int var4, boolean var5) {
    ...
    Image var11 = InventoryConfig.canvas.createImage(var6, var9);
  ...
  private final int method1005(GameString var1) {
    int var2 = 0;
