final class Deque {
  ...
  static final Parameter method1210(int var0, int var1) {
    try {
      Parameter var2 =
        (Parameter) DummyClass6.aClass47_2041.get((long) var1, 1400);
      if (var0 != 64) {
  ...
  static final GameString method1218(boolean var0, int var1, int var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "ih.A(" + var0 + ',' + var1 + ',' + var2 + ')');
    }
  }
  ...
  final void addLast(Node var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "ih.D(" + (var2 != null ? "{...}" : "null") + ')');
    }
  }
  ...
  final void method1216(int var1, Node var2) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var4, "ih.N(" + var1 + ',' + (var2 != null ? "{...}" : "null") + ')');
    }
  }
