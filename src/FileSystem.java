final class FileSystem {
  ...
  static final void method840(GameObjectConfig var0, byte var1, int var2, int var3, int var4,
    ...
    try {
      ...
      SceneShadowMap var22 = var0
        .method1696(var3, var16, var18, var5, var19, var21, false, null, (byte) -69, true, var17);
  ...
  static final void method841(boolean var0) {
    try {
      ...
      TextureSampler12
        .method171(-101, InventoryConfig.anInt3655, 0, DummyClass30.viewWidth, 0, -1,
  ...
  static final FileUnpacker createUnpacker(boolean var0, boolean var1, boolean var2, int var3,
    ...
    try {
      if (!var4) {
        ...
        Buffer.aClass151_Sub1Array2601[var3] = AbstractFileRequester.fileSystem
          .method839(-1824885439, var3, BlockConfig.tableCache, var5);
        if (var1) {
  ...
  static final SomethingTexture method843(int var0, Buffer var1) {
    try {
      ...
      throw AbstractGameWorld
        .cascadeException(var3, "al.D(" + var0 + ',' + (var1 != null ? "{...}" : "null") + ')');
    }
  }
  ...
  static final boolean method846(int var0, int var1, int var2) {
    ...
    if (var3 == -SomethingQuickChat2.anInt3539) {
      ...
      int var5 = var2 << 7;
      if (TextureSampler10
        .method349(var4 + 1, AbstractGameWorld.heightMap[var0][var1][var2], var5 + 1)
        && TextureSampler10
        .method349(var4 + 128 - 1, AbstractGameWorld.heightMap[var0][var1 + 1][var2], var5 + 1)
        && TextureSampler10
        .method349(var4 + 128 - 1, AbstractGameWorld.heightMap[var0][var1 + 1][var2 + 1],
          var5 + 128 - 1) && TextureSampler10
        .method349(var4 + 1, AbstractGameWorld.heightMap[var0][var1][var2 + 1], var5 + 128 - 1)) {
