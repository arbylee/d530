...
final class SomethingSoundEffect {
  ...
  private final int method1716(int var1, int var2, int var3) {
    return var3 == 1 ?
      ...
      (var3 == 2 ?
        anIntArray1591[var1 & 32767] * var2 >> 14 :
        (var3 == 3 ?
          ((var1 & 32767) * var2 >> 14) - var2 :
          (var3 == 4 ? anIntArray1594[var1 / 2607 & 32767] * var2 : 0)));
  }

  final int[] method1717(int var1, int var2) {
    ArrayUtils.clear(anIntArray1598, 0, var1);
    if (var2 < 10) {
      ...
      if (this.aClass34_1608 != null) {
        ...
        var5 = (int) ((double) (this.aClass34_1608.anInt605 - this.aClass34_1608.anInt603) * 32.768D
          / var3);
      ...
      if (this.aClass34_1595 != null) {
        ...
        var8 = (int) ((double) (this.aClass34_1595.anInt605 - this.aClass34_1595.anInt603) * 32.768D
          / var3);
      ...
      if (this.aClass103_1606.anIntArray1434[0] > 0 || this.aClass103_1606.anIntArray1434[1] > 0) {
        ...
        if (var1 >= var12 + var13) {
          ...
          while (var14 < var15) {
            var16 =
              (int) ((long) anIntArray1598[var14 + var12] * (long) FilterPossibly.anInt1436 >> 16);

            for (var17 = 0; var17 < var12; ++var17) {
              var16 += (int) ((long) anIntArray1598[var14 + var12 - 1 - var17]
                * (long) FilterPossibly.anIntArrayArray1435[0][var17] >> 16);
            }

            for (var17 = 0; var17 < var14; ++var17) {
              var16 -= (int) ((long) anIntArray1598[var14 - 1 - var17]
                * (long) FilterPossibly.anIntArrayArray1435[1][var17] >> 16);
            }
          ...
          while (true) {
            ...
            while (var14 < var15) {
              var16 = (int) ((long) anIntArray1598[var14 + var12] * (long) FilterPossibly.anInt1436
                >> 16);
  ...
  final void method1718(Buffer var1) {
    ...
    for (int var3 = 0; var3 < 10; ++var3) {
      int var4 = var1.readUnsignedSmart(true);
      if (var4 == 0) {
        break;
      }
      ...
      this.anIntArray1597[var3] = var1.readUnsignedSmart(true);
    }

    this.anInt1590 = var1.readUnsignedSmart(true);
    this.anInt1604 = var1.readUnsignedSmart(true);
