  ...
  static final void method338(int var0, int var1, boolean var2, int var3, int var4, int var5) {
    try {
      ...
      if (1 == SomethingPacket116.anInt1753) {
        ...
        if (MaterialShader5.aBooleanArray2169[4] && SomethingIndex150.anIntArray2073[4] + 128 > var6) {
          var6 = 128 + SomethingIndex150.anIntArray2073[4];
        }

        StillGraphic.method1952(TextureSampler20.anInt3155, -1907397104, var1, BufferData
            .method1736(GameWorldSomething.currentPlane, 1, TextureCache.localPlayer.anInt2819,
              TextureCache.localPlayer.anInt2829) + -50, 600 - -(var6 * 3), var7, FileTable.anInt942,
          var6);
      }
      ...
      if (var0 == -6403) {
        ...
        for (var11 = 0; 5 > var11; ++var11) {
          if (MaterialShader5.aBooleanArray2169[var11]) {
            var12 = (int) ((double) (-TextureSampler14.anIntArray3383[var11])
              + (double) (TextureSampler14.anIntArray3383[var11] * 2 + 1) * Math.random() + Math
              .sin((double) DummyClass9.anIntArray4009[var11] * (
        ...
        if (GlRenderer.useOpenGlRenderer) {
          ...
          GlRenderer
            .method1844(var3, var5, var4, var1, var4 / 2 + var3, var5 - -(var1 / 2), var17, var16,
              HashTable.anInt1705, HashTable.anInt1705);
        } else {
        ...
        if (GlRenderer.useOpenGlRenderer) {
          ...
          if (~DummyClass15.state == -11) {
            ...
            var12 = GameBuffer
              .method809(DisplayMode.loopCycle, TextureCache.localPlayer.waypointsY[0] >> 3,
                AbstractFileRequest.brightnessSetting, TextureCache.localPlayer.waypointsX[0] >> 3,
                1);
          }
          ...
          GameException
            .method2285(DummyClass17.anInt1823, DummyClass49.anInt1111, EnumStringFetcher.anInt2162,
              NPC.anInt3995, false, TextureSampler28.anInt3315);
          GlRenderer.anInt1791 = AbstractGameWorld.updateCycle;
          AudioSomethingSomething
            .drawScene(NPC.anInt3995, EnumStringFetcher.anInt2162, DummyClass49.anInt1111,
              DummyClass17.anInt1823, TextureSampler28.anInt3315,
              AbstractImageProducer.aByteArrayArrayArray2008, FileCache.anIntArray686,
              MilliFrameRegulator.anIntArray2696, DummyClass13.anIntArray2021,
              Player.anIntArray3959, AnimationSequence.anIntArray1871,
              GameWorldSomething.currentPlane + 1, var19, TextureCache.localPlayer.anInt2819 >> 7,
          ...
          ProceduralTexture
            .method1405(var5, var4, var3, HashTable.anInt1705, var1, HashTable.anInt1705, -7397);
          DummyClass8
            .method2221(var4, var3, var1, true, HashTable.anInt1705, HashTable.anInt1705, var5);
        } else {
        ...
        if (!var2 && !TextureSampler34.aBoolean3064 && !DummyClass36.aBoolean2615
          ...
          MaterialShader5
            .method1628(var5, var4, var1, var3, DummyClass36.anInt2612, NpcConfiguration.anInt1297,
              (byte) 97);
        }
    ...
    try {
      ...
      if (var2 != null) {
        ...
        byte[] var3 = DummyClass38.aClass153_731
          .getBytes(DummyClass41.method1170((byte) 44, var0), GameBuffer.method810((byte) 3, var0));
        ...
        if (!GlRenderer.useOpenGlRenderer) {
          var1[i] =
            new SoftwareIndexedColorSprite(SomethingVolume15.anInt2426, SomethingPacket116.anInt1748,
              Something3dRoot.anIntArray2048[i], Buffer.anIntArray2591[i], GroundItem.anIntArray2931[i],
              TextureSampler26.anIntArray3076[i], DummyClass5.aByteArrayArray2987[i],
              TextureSampler38.anIntArray3446);
        } else {
          var1[i] = new GlIndexedColorSprite(SomethingVolume15.anInt2426, SomethingPacket116.anInt1748,
            Something3dRoot.anIntArray2048[i], Buffer.anIntArray2591[i], GroundItem.anIntArray2931[i],
            TextureSampler26.anIntArray3076[i], DummyClass5.aByteArrayArray2987[i],
            TextureSampler38.anIntArray3446);
        }
