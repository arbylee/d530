    ...
    try {
      ...
      if (GlRenderer.useOpenGlRenderer && null != var9) {
        if (var9 instanceof GameObject) {
          ...
          if (null != var10) {
            FileSystem.method840(var10, (byte) -76, 0, this.anInt2724, 0, this.anInt2734,
  ...
  final void method1960(int var1) {
    try {
      if (this.aClass109_Sub1_2738 != null) {
        DummyClass16.method2047(this.aClass109_Sub1_2738, this.anInt2725, this.anInt2720,
          this.anInt2748);
      }
        ...
        if (!GlRenderer.useOpenGlRenderer) {
          ...
          if (
            ~BufferData.method1736(GameWorldSomething.currentPlane, 1, var3 - -var35, var5 - -var24)
              != ~var11 || var11 != BufferData.method1736(GameWorldSomething.currentPlane, 1,
              var3 + var23, var5 - -var25)) {
            for (var28 = 0; ~var37.anInt3891 < ~var28; ++var28) {
              var37.anIntArray3883[var28] +=
                -var11 + BufferData.method1736(GameWorldSomething.currentPlane, 1,
                  var3 + var37.anIntArray3885[var28], var5 + var37.anIntArray3895[var28]);
            }
          ...
          if (~BufferData.method1736(GameWorldSomething.currentPlane, var13 ^ -50, var3 - -var35,
            var24 + var5) != ~var11 ||
            ~BufferData.method1736(GameWorldSomething.currentPlane, 1, var23 + var3, var5 - -var25)
              != ~var11) {
            for (var28 = 0; var28 < var36.vertexCCC; ++var28) {
              var36.vy[var28] += -var11 + BufferData.method1736(GameWorldSomething.currentPlane,
                ObjectCache.bitXor(var13, -50), var36.vx[var28] - -var3, var5 + var36.vz[var28]);
            }
