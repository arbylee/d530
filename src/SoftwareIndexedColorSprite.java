final class SoftwareIndexedColorSprite extends AbstractIndexedColorSprite {

  byte[] aByteArray2674;
  private int[] anIntArray2673;


  SoftwareIndexedColorSprite(int var1, int var2, int var3, int var4, int var5, int var6,
                             byte[] var7, int[] var8) {
    this.anInt1469 = var1;
    this.anInt1467 = var2;
    this.offsetX = var3;
  ...
  SoftwareIndexedColorSprite(int var1, int var2, int var3) {
  ...
  final void method1669(int var1, int var2, int var3, int var4, int var5) {
    ...
    method1673(DummyClass47.anIntArray1100, this.aByteArray2674, this.anIntArray2673, var8, var9,
  ...
  final void draw(int var1, int var2, int var3) {
    var1 += this.offsetX;
    var2 += this.offsetY;
    ...
    if (var7 > 0 && var6 > 0) {
      method1676(DummyClass47.anIntArray1100, this.aByteArray2674, this.anIntArray2673, var5, var4,
  ...
  final void method1677(int var1, int var2, int var3, int var4) {
    ...
    method1670(DummyClass47.anIntArray1100, this.aByteArray2674, this.anIntArray2673, var7, var8,
