...
abstract class Something3dRoot {

  static int[] anIntArray2048;
  static int anInt2050;
  static int anInt2051;
  static FileUnpacker configs;
  static GameString aClass94_2053 = SpawnedGameObject.createString("Update)2Liste geladen)3");
  static Widget aClass11_2055;
  static Model[] aClass140_Sub5Array2058 = new Model[4];
  static int anInt2059;
  static GameString aClass94_2061 = SpawnedGameObject.createString("Forced tweening disabled)3");
  int anInt2062 = 4;
  ...
  Something3dRoot(int var1, int var2, int var3, int var4, int var5) {
    try {
      this.anInt2056 = var4;
      this.anInt2062 = var2;
      this.anInt2054 = var1;
