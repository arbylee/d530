    ...
    try {
      ...
      if (~var1.anInt2816 != -1) {
        if (~var1.animationId != 0 && 0 == var1.anInt2828) {
          AnimationSequence var3 = GameClient.method45(var1.animationId, (byte) -20);
        ...
        int var5 = var1.waypointsX[-1 + var1.anInt2816] * 128 - -(var1.getSize() * 64);
        int var6 = 128 * var1.waypointsY[-1 + var1.anInt2816] - -(var1.getSize() * 64);
        if (-257 > ~(var5 + -var18) || -var18 + var5 < -256 || ~(var6 - var4) < -257
          || -256 > var6 - var4) {
          var1.anInt2819 = var5;
          var1.anInt2829 = var6;
          return;
        ...
        if (var10) {
          if (~var1.rotationY != ~var1.anInt2806 && 0 == ~var1.anInt2772 && ~var1.anInt2779 != -1) {
            var9 = 2;
          }
        ...
        if (var2.anInt360 != -1) {
          ...
          if (-2 == ~var1.anInt2816) {
            int var13 =
              (~var5 <= ~var1.anInt2819 ? var5 - var1.anInt2819 : -var5 + var1.anInt2819) << 7;
            int var12 = var1.anInt2758 * var1.anInt2758;
            int var14 =
              (~var6 > ~var1.anInt2829 ? -var6 + var1.anInt2829 : -var1.anInt2829 + var6) << 7;
