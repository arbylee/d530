final class DummyClass53 {
  ...
  static AbstractDirectColorSprite aClass3_Sub28_Sub16_1339;
  static volatile int anInt1340 = -1;
  static GameString LOGO = SpawnedGameObject.createString("logo");
  ...
  static final void method1583(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
  ...
  static final int nearestPo2(byte var0, int var1) {
    try {
      --var1;
      var1 |= var1 >>> 1;
      var1 |= var1 >>> 2;
  ...
  static final GameString method1586(int var0, int var1) {
    try {
      if (-1 > ~var1 && -256 <= ~var1) {
